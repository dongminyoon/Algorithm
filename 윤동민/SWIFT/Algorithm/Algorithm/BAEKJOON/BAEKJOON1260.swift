...
struct BAEKJOON1260 {
    static var dfsVisited: [Bool] = []
    static var bfsVisited: [Bool] = []
    static var dfsRoot: [Int] = []
    static var bfsRoot: [Int] = []
    ...
    static func dfs(_ startIndex: Int, _ map: [[Int]]) {
    ...
    static func bfs(_ startIndex: Int, _ map: [[Int]]) {
