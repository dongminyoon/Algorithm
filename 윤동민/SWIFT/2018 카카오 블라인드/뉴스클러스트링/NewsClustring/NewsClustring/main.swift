...
func isCharacter(at str: String) -> Int {
...
func searchIntersection(_ splitedString1: [String], _ splitedString2: [String]) -> [String] {
...
func searchUnion(_ splitedString1: [String], _ splitedString2: [String]) -> [String] {
    var visited: [Bool] = Array(repeating: false, count: splitedString2.count)
    var union: [String] = []
